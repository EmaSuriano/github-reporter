...
describe('Statistics', () => {
  describe('createConfiguration', () => {
    ...
    describe('onClick instance', () => {
      ...
      describe('when canvas is equal to "by-language"', () => {
        ...
        it('should call window open once', () => expect(spyWindow).toHaveBeenCalledTimes(1));
      ...
      describe('when canvas is equal to "by-repository"', () => {
        ...
        it('should call window open with the proper link and _blank property', () =>
          expect(spyWindow).toHaveBeenCalledWith('https://github.com/wesbos/linkLabel', '_blank'));
      });
    });
  });
  ...
  describe('getEndCursor', () => {
    ...
    it('should return "cursorId" as endCursor prop', () => expect(result).toBe('cursorId'));
  });
  ...
  describe('hasNextPage', () => {
    ...
    describe('when "hasNextPage" prop does not exist', () => {
      ...
      it('should return false as default value', () => expect(result).toBeFalsy());
    });
  });
