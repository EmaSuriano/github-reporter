...
import { getEdges, getPageInfo, updateRepositoryData } from 'screens/Profile/utils';
...
describe('Update Query Function', () => {
  ...
  describe('when has new edges', () => {
    ...
    it('should call getEdges twice', () => expect(getEdges).toHaveBeenCalledTimes(2));
    ...
    it('should call getPageInfo once', () => expect(getPageInfo).toHaveBeenCalledTimes(1));
    ...
    it('should call updateRepositoryData with calculated data', () =>
      expect(updateRepositoryData).toHaveBeenCalledWith('previousEdges', [1, 2, 1, 2], 'New Page'));
  ...
  describe("when hasn't new edges", () => {
    ...
    it('should call once getEdges', () => expect(getEdges).toHaveBeenCalledTimes(1));
    it("should call getEdges with 'nextEdges'", () =>
      expect(getEdges).toHaveBeenCalledWith('nextEdges'));
    it('should not call getPageInfo', () => expect(getPageInfo).toHaveBeenCalledTimes(0));
    it('should not call updateRepositoryData', () =>
      expect(updateRepositoryData).toHaveBeenCalledTimes(0));
    it('should return data from previousResult', () => expect(result).toEqual('previousEdges'));
  });
});
